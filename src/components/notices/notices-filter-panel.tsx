...
import { SlidersHorizontal, RotateCcw, Building2, Calendar, ShieldCheck } from "lucide-react";
...
export function NoticesFilterPanel({ institutions }: Props) {
  ...
  const hasActiveFilters = currentSource !== "" || currentInstitution !== "" || currentDate !== "";
