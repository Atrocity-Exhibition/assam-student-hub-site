              ...
              {notices.map((notice) => {
                ...
                return (
                  <Link
                    ...
                    className="block"
                  >
                    <article className={`group h-full flex flex-col justify-between rounded-2xl sm:rounded-3xl border border-border bg-card/40 backdrop-blur-sm p-4 sm:p-6 overflow-hidden transition-all duration-300 hover:-translate-y-0.5 hover:bg-muted/5 shadow-sm min-h-[190px] sm:min-h-[210px] ${hoverClasses.border}`}>
